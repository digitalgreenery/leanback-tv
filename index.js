/*
 * This file is part of Leanback-TV.
 * Originally MIT-licensed code from VacuumTube.
 * This fork is licensed under the Mozilla Public License 2.0 (MPL-2.0).
 */
...
electron.app.setName('Leanback-TV')
...
const youtubeUserAgent = `Mozilla/5.0 (PS4; Leanback Shell) Cobalt/26.lts.0-qa; compatible; Leanback-TV/${package.version}` //for youtube
const userAgent = `Leanback-TV/${package.version}` //for anything else
...
async function createWindow() {
    ...
    //keep window title as Leanback-TV
    win.webContents.on('page-title-updated', () => {
        win.setTitle('Leanback-TV')
    })
}
